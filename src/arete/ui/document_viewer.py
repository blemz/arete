...
class DocumentRenderer:
    ...
    def __init__(self):
        ...
        self.current_document: DocumentContent | None = None
    ...
    def handle_citation_click(self, citation_id: str):
        ...
        if clicked_citation:
            ...
            st.session_state["selected_citation"] = clicked_citation
            st.session_state["citation_details_expanded"] = True
...
class SplitViewLayout:
    ...
    def render_split_view(self, chat_interface, document: DocumentContent | None = None):
    ...
    def _render_document_only(self, document: DocumentContent | None):
    ...
    def _render_split_layout(self, chat_interface, document: DocumentContent | None, split_ratio: int):
...
class DocumentSearchInterface:
    ...
    def render_document_selector(self) -> DocumentContent | None:
        ...
        with col2:
            author_filter = st.selectbox(
                "Filter by Author",
                ["All"] + list({doc.author for doc in self.available_documents if doc.author}),
                key="author_filter"
            )
