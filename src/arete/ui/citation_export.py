...
class CitationExporter:
    ...
    def __init__(self, config: CitationExportConfig | None = None):
    ...
    def _export_chicago(self, citations: list[Any]) -> str:
        ...
        if self.config.timestamp:
            output.write("# Citations (Chicago Style)\n")
    ...
    def _export_classical(self, citations: list[Any]) -> str:
        ...
        if self.config.timestamp:
            output.write("Classical Citations\n")
    ...
    def get_filename(self, format: ExportFormat | None = None) -> str:
