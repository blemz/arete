...
class DocumentRepository(SearchableRepository[Document]):
    ...
    async def get_by_id(self, entity_id: UUID | str) -> Document | None:
        ...
        """
        try:
            result = await self._neo4j_client.get_node_by_id(str(entity_id), "Document")
    ...
    async def delete(self, entity_id: UUID | str) -> bool:
        ...
        try:
            ...
            await self._weaviate_client.delete_entity("Document", str(entity_id))
    ...
    async def search_content(
        ...
        try:
            ...
            weaviate_results = await self._weaviate_client.search_near_text(
                collection="Document", query=query, limit=limit, certainty=0.6
            )
