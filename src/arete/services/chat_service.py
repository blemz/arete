...
class ChatService:
        ...
        for session in sessions:
            ...
            # Search in message content and citations if enabled
                ...
                for message in session.messages:
                    if query_lower in message.content.lower() or any(
                        query_lower in citation.lower()
    ...
    def get_session_statistics(self, user_id: str) -> Dict[str, Any]:
        ...
        return {
            ...
            "paused_sessions": len(
                [s for s in sessions if s.status == SessionStatus.PAUSED]
            ),
    ...
    def generate_conversation_summary(self, session_id: str) -> Optional[str]:
        ...
        for message in session.messages:
            ...
            for philosopher in [
                ...
                if philosopher in content_lower and philosopher not in [
                    p.lower() for p in philosophers
                ]:
    ...
    def analyze_philosophical_topics(self, session_id: str) -> Dict[str, Any]:
        ...
        for philosopher, related_topics in philosopher_map.items():
            if philosopher in all_content:
                ...
                topics.extend(
                    [topic for topic in related_topics if topic in all_content]
                )
    ...
    def prepare_session_for_sharing(self, session_id: str) -> Optional[Dict[str, Any]]:
        ...
        share_data = {
            ...
            or self.generate_conversation_summary(session_id),
            "tags": session.tags,
            "context": {
