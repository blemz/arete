...
class IntelligentLLMRouter:
    ...
    async def route_request(self, request: RoutingRequest) -> LLMResponse:
        ...
        try:
            ...
            for provider_name, score in ranked_providers:
                try:
                    logger.info(
                        f"Routing request to {provider_name} (score: {score:.3f})"
                    )
    ...
    def _score_providers(
        ...
        for provider_name in available_providers:
            ...
            if (
                ...
                and provider_name in request.preferred_providers
            ):
    ...
    def _calculate_provider_score(
        self, request: RoutingRequest, capabilities: ProviderCapabilities
    ) -> float:
    ...
    def _update_performance_history(
        self, provider_name: str, success: bool, score: float
    ) -> None:
    ...
    def update_provider_capabilities(
        self, provider_name: str, capabilities: ProviderCapabilities
    ) -> None:
