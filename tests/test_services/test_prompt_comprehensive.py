...
try:
    from arete.services.prompt_templates import PromptTemplate, PromptStyle, build_enhanced_prompt  # noqa: PLC0415
except ImportError:
    # Try alternative import path
    sys.path.insert(0, os.path.dirname(__file__))
    from src.arete.services.prompt_templates import PromptTemplate, PromptStyle, build_enhanced_prompt  # noqa: PLC0415
