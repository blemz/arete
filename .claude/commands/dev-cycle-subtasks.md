...
**Purpose**: Execute a complete development phase using Test-Driven Development methodology, following the roadmap in planning\todo.md and planning\aesthetics_plan.md.
...
- Read @planning\todo.md to understand current progress
...
- Update @planning\todo.md with completion status
...
- After /clear, the next cycle begins automatically by reading the updated planning\todo.md and implementing the next identified phase.
